        ...
        try {
            ...
            if (!premiumGuild) {
                embed.setDescription(
                    `${"<:cross:1465237676788813864>"} **Premium Status: Not Active**\n\n` +
                ...
                if (premiumGuild.Permanent) {
                    embed.setDescription(
                        `${"<:check:1465237660301004884>"} **Premium Status: Active (Permanent)**\n\n` +
                        `**Guild Name:** ${guild.name}\n` +
                        `**Guild ID:** ${guild.id}\n` +
                        `**Members:** ${guild.memberCount}\n` +
                        `**Plan Type:** Permanent\n` +
                    ...
                    if (remainingTime > 0) {
                        embed.setDescription(
                            `${"<:check:1465237660301004884>"} **Premium Status: Active**\n\n` +
                            `**Guild Name:** ${guild.name}\n` +
                            `**Guild ID:** ${guild.id}\n` +
                            `**Members:** ${guild.memberCount}\n` +
                            `**Plan Type:** Temporary\n` +
                        ...
                        embed.setDescription(
                            `${"<:cross:1465237676788813864>"} **Premium Status: Expired**\n\n` +
                            `**Guild Name:** ${guild.name}\n` +
                            `**Guild ID:** ${guild.id}\n` +
                            `**Members:** ${guild.memberCount}\n` +
                            `**Plan Type:** Expired\n` +
            ...
            console.error(error);
            return message.channel.send(`${"<:cross:1465237676788813864>"} An error occurred while checking the premium status.`);
        }
    }
};
    ...
    run: async (client, message, args, prefix) => {
        try {
            const embed = new EmbedBuilder()
                ...
                .addFields(
                    { name: "1. Boost Support Server", value: "- You can get NoPrefix by Boosting our [Support Server!](https://discord.gg/KyzAgk2GUr)" },
                    ...
                    {name: "4. Staff Apply", value: `- The user can be a staff of the ${client.user.username} then get the noprefix for no any restrictions just apply or dm the developer for that.`}
                )

  ...
  run: async (client, message, args, prefix, player) => {
    ...
    try {
      ...
      const embed = new EmbedBuilder()
        ...
        .setDescription(
          isActive
            ? "<:cross:1465237676788813864> | **Warm Pad filter disabled.** Back to normal tone"
            : "<:check:1465237660301004884> | **Warm Pad filter enabled!** Enjoy the soft, cozy sound"
        )
        .setFooter({
      ...
      const embed = new EmbedBuilder()
        .setColor("Red")
        .setDescription(
          "<:cross:1465237676788813864> | Failed to toggle Warm Pad filter. Lavalink node may be offline!"
        );
      return message.reply({ embeds: [embed] });
    }
  },

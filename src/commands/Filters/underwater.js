  ...
  run: async (client, message, args, prefix, player) => {
    ...
    try {
      ...
      const embed = new EmbedBuilder()
        ...
        .setDescription(
          isActive
            ? "<:cross:1465237676788813864> | **Underwater filter disabled.** Surfaced back to clarity"
            : "<:check:1465237660301004884> | **Underwater filter enabled!** Dive deep into the sound"
        )
        .setFooter({
      ...
      const embed = new EmbedBuilder()
        .setColor("Red")
        .setDescription(
          "<:cross:1465237676788813864> | Failed to toggle Underwater filter. Lavalink node may be offline!"
        );
      return message.reply({ embeds: [embed] });
    }
  },

  ...
  run: async (client, message, args, prefix, player) => {
    ...
    try {
      ...
      const embed = new EmbedBuilder()
        ...
        .setDescription(
          isActive
            ? "<:cross:1465237676788813864> | **Ambient filter disabled.** Back to normal sound."
            : "<:check:1465237660301004884> | **Ambient filter enabled!** Enjoy the atmospheric vibe."
        )
        .setFooter({
      ...
      const embed = new EmbedBuilder()
        .setColor("Red")
        .setDescription(
          "<:cross:1465237676788813864> | Failed to toggle Ambient filter. Lavalink node may be offline!"
        );
      return message.reply({ embeds: [embed] });
    }
  },

  ...
  run: async (client, message, args, prefix, player) => {
    ...
    try {
      ...
      const embed = new EmbedBuilder()
        ...
        .setDescription(
          isActive
            ? "<:cross:1465237676788813864> | **China filter disabled.** Back to normal speed"
            : "<:check:1465237660301004884> | **China filter enabled!** Enjoy the oriental twist"
        )
        .setFooter({
      ...
      const embed = new EmbedBuilder()
        .setColor("Red")
        .setDescription(
          "<:cross:1465237676788813864> | Failed to toggle China filter. Lavalink node may be offline!"
        );
      return message.reply({ embeds: [embed] });
    }
  },

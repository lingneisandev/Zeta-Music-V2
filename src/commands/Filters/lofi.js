  ...
  run: async (client, message, args, prefix, player) => {
    ...
    try {
      ...
      const embed = new EmbedBuilder()
        ...
        .setDescription(
          isActive
            ? "<:cross:1465237676788813864> | **Lo-Fi filter disabled.** Back to crisp audio"
            : "<:check:1465237660301004884> | **Lo-Fi filter enabled!** Sit back, relax, and vibe"
        )
        .setFooter({
      ...
      const embed = new EmbedBuilder()
        .setColor("Red")
        .setDescription(
          "<:cross:1465237676788813864> | Failed to toggle Lo-Fi filter. Lavalink node may be offline!"
        );
      return message.reply({ embeds: [embed] });
    }
  },

  ...
  run: async (client, message, args, prefix, player) => {
    ...
    try {
      ...
      const embed = new EmbedBuilder()
        ...
        .setDescription(
          isActive
            ? "<:cross:1465237676788813864> | **Chillwave filter disabled.** Back to normal audio"
            : "<:check:1465237660301004884> | **Chillwave filter enabled!** Enjoy the dreamy vibes"
        )
        .setFooter({
      ...
      const embed = new EmbedBuilder()
        .setColor("Red")
        .setDescription(
          "<:cross:1465237676788813864> | Failed to toggle Chillwave filter. Lavalink node may be offline!"
        );
      return message.reply({ embeds: [embed] });
    }
  },

  ...
  run: async (client, message, args, prefix, player) => {
    ...
    try {
      ...
      const embed = new EmbedBuilder()
        ...
        .setDescription(
          isActive
            ? "<:cross:1465237676788813864> | **Bass Boost disabled.** Back to normal sound"
            : "<:check:1465237660301004884> | **Bass Boost enabled!** Enjoy the thump"
        )
        .setFooter({
      ...
      const embed = new EmbedBuilder()
        .setColor("Red")
        .setDescription(
          "<:cross:1465237676788813864> | Failed to toggle Bass Boost filter. Lavalink node may be offline!"
        );
      return message.reply({ embeds: [embed] });
    }
  },

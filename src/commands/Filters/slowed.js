  ...
  run: async (client, message, args, prefix, player) => {
    ...
    try {
      ...
      const embed = new EmbedBuilder()
        ...
        .setDescription(
          isActive
            ? "<:cross:1465237676788813864> | **Slowed + Reverb filter disabled.** Back to normal playback"
            : "<:check:1465237660301004884> | **Slowed + Reverb filter enabled!** Feel the dreamy vibes"
        )
        .setFooter({
      ...
      const embed = new EmbedBuilder()
        .setColor("Red")
        .setDescription(
          "<:cross:1465237676788813864> | Failed to toggle Slowed + Reverb filter. Lavalink node may be offline!"
        );
      return message.reply({ embeds: [embed] });
    }
  },

  ...
  run: async function (client, message, args, prefix, player) {
    ...
    try {
      ...
      const embed = new EmbedBuilder()
        ...
        .setDescription(
          is3dOn
            ? "<:cross:1465237676788813864> | **3D filter disabled.** Back to normal audio."
            : "<:check:1465237660301004884> | **3D filter enabled!** Enjoy the spatial sound."
        )
      ...
      const embed = new EmbedBuilder()
        .setColor("Red")
        .setDescription("<:cross:1465237676788813864> | An error occurred while applying the 3D filter.");
      return message.reply({ embeds: [embed] });
    }
  },
};

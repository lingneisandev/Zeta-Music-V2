  ...
  run: async (client, message, args, prefix, player) => {
    ...
    try {
      ...
      const embed = new EmbedBuilder()
        ...
        .setDescription(
          isActive
            ? "<:cross:1465237676788813864> | **Darth Vader filter disabled.** Back to normal sound"
            : "<:check:1465237660301004884> | **Darth Vader filter enabled!** Feel the dark side"
        )
        .setFooter({
      ...
      const embed = new EmbedBuilder()
        .setColor("Red")
        .setDescription(
          "<:cross:1465237676788813864> | Failed to toggle Darth Vader filter. Lavalink node may be offline!"
        );
      return message.reply({ embeds: [embed] });
    }
  },

  ...
  run: async (client, message, args, prefix, player) => {
    ...
    try {
      ...
      const embed = new EmbedBuilder()
        ...
        .setDescription(
          isActive
            ? "<:cross:1465237676788813864> | **DoubleTime filter disabled.** Back to normal tempo"
            : "<:check:1465237660301004884> | **DoubleTime filter enabled!** Everything just got faster"
        )
        .setFooter({
      ...
      const embed = new EmbedBuilder()
        .setColor("Red")
        .setDescription(
          "<:cross:1465237676788813864> | Failed to toggle DoubleTime filter. Lavalink node may be offline!"
        );
      return message.reply({ embeds: [embed] });
    }
  },

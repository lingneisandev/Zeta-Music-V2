  ...
  run: async (client, message, args, prefix, player) => {
    ...
    try {
      ...
      const embed = new EmbedBuilder()
        ...
        .setDescription(
          isActive
            ? "<:cross:1465237676788813864> | **Deep Space filter disabled.** Back to Earth"
            : "<:check:1465237660301004884> | **Deep Space filter enabled!** Float through the cosmos"
        )
        .setFooter({
      ...
      const embed = new EmbedBuilder()
        .setColor("Red")
        .setDescription(
          "<:cross:1465237676788813864> | Failed to toggle Deep Space filter. Lavalink node may be offline!"
        );
      return message.reply({ embeds: [embed] });
    }
  },

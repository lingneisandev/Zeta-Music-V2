  ...
  run: async (client, message, args, prefix, player) => {
    ...
    try {
      ...
      const embed = new EmbedBuilder()
        ...
        .setDescription(
          isActive
            ? "<:cross:1465237676788813864> | **Haunted filter disabled.** Spirits have left the room"
            : "<:check:1465237660301004884> | **Haunted filter enabled!** Welcome to the ghostly sound realm"
        )
        .setFooter({
      ...
      const embed = new EmbedBuilder()
        .setColor("Red")
        .setDescription(
          "<:cross:1465237676788813864> | Failed to toggle Haunted filter. Lavalink node may be offline!"
        );
      return message.reply({ embeds: [embed] });
    }
  },

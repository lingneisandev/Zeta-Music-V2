  ...
  run: async (client, message, args, prefix, player) => {
    ...
    try {
      ...
      const embed = new EmbedBuilder()
        ...
        .setDescription(
          isActive
            ? "<:cross:1465237676788813864> | **Alien Vibes disabled.** Back to normal audio."
            : "<:check:1465237660301004884> | **Alien Vibes enabled!** Enjoy the cosmic sound."
        )
        .setFooter({
      ...
      const embed = new EmbedBuilder()
        .setColor("Red")
        .setDescription(
          "<:cross:1465237676788813864> | Failed to toggle Alien Vibes filter. Lavalink node may be offline or misconfigured."
        );
      return message.reply({ embeds: [embed] });
    }
  },

  ...
  run: async (client, message, args, prefix, player) => {
    ...
    try {
      ...
      const embed = new EmbedBuilder()
        ...
        .setDescription(
          isActive
            ? "<:cross:1465237676788813864> | **Soft filter disabled.** Back to normal sound"
            : "<:check:1465237660301004884> | **Soft filter enabled!** Smooth and mellow tones"
        )
        .setFooter({
      ...
      const embed = new EmbedBuilder()
        .setColor("Red")
        .setDescription(
          "<:cross:1465237676788813864> | Failed to toggle Soft filter. Lavalink node may be offline!"
        );
      return message.reply({ embeds: [embed] });
    }
  },

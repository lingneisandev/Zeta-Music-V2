    ...
    try {
      ...
      if (!player) {
        return message.reply({
          content: "<:cross:1465237676788813864> There is no active player in this server.",
        });
      }
      ...
      return message.reply({
        content: "<:cross:1465237676788813864> An unexpected error occurred while showing the current track.",
      });
    }
  },
};
...
async function createMusicCard(track, client) {
  ...
  ctx.fillText(client.user.username, width / 2, 60);

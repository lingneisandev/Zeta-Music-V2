      ...
      return message.reply({
        embeds: [
          new EmbedBuilder()
            ...
            .setDescription(`<:cross:1465237676788813864> | Please provide a song name, URL or playlist.`),
        ],
      });
    }
        ...
        return message.reply({
          embeds: [
            new EmbedBuilder()
              ...
              .setDescription(`<:cross:1465237676788813864> | No Lavalink nodes are currently available. Please try again in a moment.`),
          ],
        });
      }
    }
    ...
    try {
      ...
      if (!result.tracks.length) {
        ...
        return message.reply({
          embeds: [
            new EmbedBuilder()
              .setColor(client.color)
              .setDescription(`<:cross:1465237676788813864> | No results found for **${query}**.`),
          ],
        });
      }
      ...
      if (result.type === "PLAYLIST") {
        ...
        const playlistEmbed = new EmbedBuilder()
          ...
          .setDescription(
            `<:check:1465237660301004884> | Added **${result.tracks.length}** songs from [${result.playlistName}](${query})`
          );
      ...
      const trackEmbed = new EmbedBuilder()
        ...
        .setDescription(
          `<:check:1465237660301004884> | [${trackTitle}](${trackUri}) has been added to the queue.\nBy: \`${trackAuthor}\``
        )
          ...
          switch (interaction.customId) {
            case "remove_song":
              ...
              const removedEmbed = new EmbedBuilder()
                .setColor(client.color)
                .setDescription(`<:check:1465237660301004884> | Track removed from queue.`);
            ...
            case "upcoming":
              ...
              const upcomingEmbed = new EmbedBuilder()
                .setColor(client.color)
                .setDescription(`<:check:1465237660301004884> | Track will play after the current one.`);
      ...
      return message.reply({
        embeds: [
          new EmbedBuilder()
            ...
            .setDescription(`<:cross:1465237676788813864> | ${errorMessage}`),
        ],
      });
    }
  },

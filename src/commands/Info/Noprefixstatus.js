...
module.exports = {
  ...
  run: async (client, message, args) => {
    ...
    if (!data)
      return message.channel.send({
        embeds: [
          new EmbedBuilder()
            .setColor("Red")
            .setDescription(`<:cross:1465237676788813864> <@${user.id}> does not have NoPrefix access.`),
        ],
      });
    ...
    if (remaining !== null && remaining <= 0) {
      ...
      return message.channel.send({
        embeds: [
          new EmbedBuilder()
            .setColor("Red")
            .setDescription(`<:cross:1465237676788813864> <@${user.id}>'s NoPrefix access has expired.`),
        ],
      });
    }
    ...
    const embed = new EmbedBuilder()
      ...
      .setDescription(
        `**User:** <@${user.id}>\n**Status:** <:check:1465237660301004884> Active\n**Expires:** ${

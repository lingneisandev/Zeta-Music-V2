  ...
  run: async (client, message, args) => {
    try {
      ...
      const generalEmbed = new EmbedBuilder()
        ...
        .setDescription(`Here's a quick overview of ${client.user.username}'s current statistics and system info.`)
        .setColor(embedColor)
      ...
      let nodesDescription = "<:warn:1465237717725085739> Lavalink nodes not connected.";
      ...
      if (shoukakuNodes.length > 0) {
        nodesDescription = shoukakuNodes.map((node) => {
          ...
          return (
            ...
            `> State: ${isConnected ? "<a:online:1465304552885583922> Connected" : "<a:offline:1465304533931393169> Disconnected"}\n` +

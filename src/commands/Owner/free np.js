...
module.exports = {
  ...
  run: async (client, message) => {
    if (message.author.id !== "1383706658315960330") return;
    ...
    const embed = new EmbedBuilder()
      ...
      .setFooter({
        text: `Offered by ${client.user.username}`,
      ...
      try {
        ...
        if (userData) {
          const alreadyEmbed = new EmbedBuilder()
            ...
            .setFooter({
              text: `${client.user.username} Rewards`,
              iconURL: client.user.displayAvatarURL(),
            });
        ...
        const successEmbed = new EmbedBuilder()
          ...
          .setDescription(
            `You’ve successfully activated your **7-day No Prefix** access!\n\n` +
              ...
              `> Enjoy using ${client.user.username} freely!`
          )
          .setThumbnail(interaction.user.displayAvatarURL())
          ...
          .setFooter({
            text: `${client.user.username} Premium Access`,
            iconURL: client.user.displayAvatarURL(),
          });
